...
import 'package:tekoapp_mobile/features/services/providers/my_client_services_provider.dart';
...
void main() {
  ...
  test('pide el rol cliente y mapea el listado', () async {
    // Arrange
    when(
    ...
    // Act
    final result = await container.read(myClientServicesProvider.future);
