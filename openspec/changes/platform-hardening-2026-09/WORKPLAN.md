...
| M-04 | ALTO | [x] | 11a1685 | Script propio (no openapi_generator/swagger_dart_code_generator); PoC en `ratings`, probado contra fixture local — ver CODEGEN.md. Cabo suelto cerrado en 6649ddd/c75cb89/dbd8561: payments/services/professional_profile migrados contra `--openapi-url` real — ver CODEGEN.md §7.1 |
