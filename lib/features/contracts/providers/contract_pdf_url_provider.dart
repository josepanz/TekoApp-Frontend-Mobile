...
/// puntual).
final contractPdfUrlProvider = FutureProvider.autoDispose
    .family<String, String>((ref, contractReferenceId) {
  return ref
      .watch(contractsRepositoryProvider)
      .fetchPdfUrl(contractReferenceId);
});
